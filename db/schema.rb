...
ActiveRecord::Schema.define(version: 2020_11_04_214038) do
  ...
  create_table "locations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["group_event_id"], name: "index_locations_on_group_event_id"
  end
  ...
  add_foreign_key "locations", "group_events"
end
